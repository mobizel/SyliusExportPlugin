...
final class GreetingController extends Controller
{
    ...
    {
        return $this->render('@MobizelSyliusExportPlugin/static_greeting.html.twig', ['greeting' => $this->getGreeting($name)]);
    }
    ...
    {
        return $this->render('@MobizelSyliusExportPlugin/dynamic_greeting.html.twig', ['greeting' => $this->getGreeting($name)]);
    }
